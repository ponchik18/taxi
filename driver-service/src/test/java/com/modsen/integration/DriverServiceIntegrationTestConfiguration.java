...
@TestConfiguration
public class DriverServiceIntegrationTestConfiguration {
    ...
    private Map<String, Object> testProducerConfigs() {
        ...
        props.put(
                DriverServiceTestConstants.KafkaProperties.TRUSTED_PACKAGE_KEY,
                DriverServiceTestConstants.KafkaProperties.TRUSTED_PACKAGE_VALUE
        );
        return props;
    }
